...
import { BannedUsersApiService, BannedUserResponse, BannedUser } from '../banned-users-api/banned-users-api.service';
...
export class BannedUsersListComponent  implements AfterViewInit{
  ...
  constructor(private _bannedUsersService: BannedUsersApiService) { }
